...
describe('E2E testing to buy mobile data ', async() =>{
    ...
    it('Select a provider to buy its mobile data & put it into cart', async() => {
        await pulsa.geserlist()
        await driver.sleep(2000)
        await pulsa.bukatabpulsa()
        await driver.sleep(2000)
        await driver.wait(until.elementLocated(By.xpath('//p[contains(text(), "Indosat")]')), 10000).click()
        await driver.wait(until.elementLocated(By.xpath('//div[contains(@class, "grid grid-flow")]/a[3]')),10000).click()
        await driver.wait(until.elementLocated(By.xpath('//div[contains(@class, "w-full grid")]')),10000)
        await driver.sleep(2000)
        await pulsa.input('085669387656')
        await driver.sleep(2000)
        await pulsa.add()
